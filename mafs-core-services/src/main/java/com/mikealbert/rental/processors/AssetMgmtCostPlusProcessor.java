...
import com.mikealbert.rental.processors.inputoutput.AssetMgmtCostPlusProcessorInput;
...
@Component("assetMgmtCostPlusProcessor")
public class AssetMgmtCostPlusProcessor extends BaseProcessor implements LeaseElementProcessor {
	private MalLogger logger = MalLoggerFactory.getLogger(this.getClass());
	
	@Resource(name="capitalCosts") private QuoteCapitalCosts capitalCostsCalc;
	...
	public ProcessorOutputType process(ProcessorInputType processorInputType) throws MalBusinessException {
		if (!(processorInputType instanceof AssetMgmtCostPlusProcessorInput))
			throw new MalBusinessException("not_a_valid_argument_for",new String[]{"AssetMgmtCostPlusProcessor"});
		try{
			AssetMgmtCostPlusProcessorInput input = (AssetMgmtCostPlusProcessorInput) processorInputType;
			input.loadQuoteData();
