...
@Component("vmpProcessorInput")
@Scope(value = "prototype")
public class VmpProcessorInput extends BaseRentalProcessorInput {
    ...
    public BigDecimal getVmpFee() {
	return vmpFee;
    }

    public void setVmpFee(BigDecimal vmpFee) {
	this.vmpFee = vmpFee;
    }
