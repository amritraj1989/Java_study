...
public class MainPoVO {
	...
	private String totalTaxableText;
	...
	public String getTotalTaxableText() {
		return totalTaxableText;
	}

	public void setTotalTaxableText(String totalTaxableText) {
		this.totalTaxableText = totalTaxableText;
	}
